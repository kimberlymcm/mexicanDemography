...
#SBATCH --job-name="Branching_dadi_models"
...
date
echo "This job runs the 4 population dadi model with branching topology on native mexican data."
...
python2.7 ../../scripts/python/run_model_server_branching.py
